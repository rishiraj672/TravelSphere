...
public class Home extends JFrame{
	...
	NewLabel.setBounds(0, 0, 1950, 900); 
        add(NewLabel);
        
        JLabel l1 = new JLabel("TravelSphere");
	l1.setForeground(new Color(255,51,51));
        l1.setFont(new Font("Tahoma", Font.PLAIN, 80));
	l1.setBounds(600, 60, 1000, 150);
	NewLabel.add(l1);
		
		
        JMenuBar menuBar = new JMenuBar();
        menuBar.setBackground(new Color(0,0,102));
        menuBar.setPreferredSize(new Dimension(0, 250));
	setJMenuBar(menuBar);
		
        JMenu m1 = new JMenu("CUSTOMER");
        m1.setForeground(Color.YELLOW);
        m1.setFont(new Font("Tahoma", Font.PLAIN,40));
	menuBar.add(m1);
	...
	JMenu m2 = new JMenu("  PACKAGES");
        ...
        m2.setFont(new Font("Tahoma", Font.PLAIN,40));
	menuBar.add(m2);
	...
	mi5.addActionListener(new ActionListener(){
        ...
        m3.setFont(new Font("Tahoma", Font.PLAIN,40));
	...
	mi9.addActionListener(new ActionListener(){
        ...
        m4.setFont(new Font("Tahoma", Font.PLAIN,40));
	...
	m4.add(mi11);
        ...
        m5.setFont(new Font("Tahoma", Font.PLAIN,40));
	...
	m5.add(mi12);
        ...
        m6.setFont(new Font("Tahoma", Font.PLAIN,40));
	...
	m6.add(mi14);
        ...
        m7.setFont(new Font("Tahoma", Font.PLAIN,40));
